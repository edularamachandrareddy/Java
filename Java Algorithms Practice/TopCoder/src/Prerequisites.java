...
4) If the inputed course schedule has errors, return a String[] of length 0.
...
have its own entry in the inputed String[].
...
public class Prerequisites {
	...
	public String[] orderClasses(String[] args){
